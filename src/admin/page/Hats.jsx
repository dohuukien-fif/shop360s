...
import ProductItemHats from '../component/productAdmin/productItemHats';
...
function ProductFeatures(props) {
  ...
  const { productCategories } = useCategories(
    'https://api-product-json.herokuapp.com/categoriesHat'
  );
  const { productMaxPrice } = useMaxPrice('https://api-product-json.herokuapp.com/mu');
