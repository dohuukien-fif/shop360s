...
import ProductItemShirts from '../../component/productAdmin/productItemShirts';
...
function ProductFeatures(props) {
  ...
  const { productCategories } = useCategories(
    'https://api-product-json.herokuapp.com/categoriesShirt'
  );
  const { productMaxPrice } = useMaxPrice('https://api-product-json.herokuapp.com/shrit');
