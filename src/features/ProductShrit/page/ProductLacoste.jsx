...
import ProductLacoste from './../component/product/productList/ProductLacoste/index';
import './stylesQuanJeans.scss';
import ProductFilter from './../component/product/ProductFilter/FilterAoLacoste/index';
  ...
  return (
    <div className="product_trouser">
      <div className="product_trouser_title-trouser">
        <span>
          {' '}
          <Link to="/">Trang chủ</Link> / <Link to="/Ao">Áo</Link> / Áo Lacoste
        </span>
      </div>
      ...
      <div className="content_trouser">
        ...
        <div className="content_trouser_right-trouser">
          ...
          {Loading ? <Seleken length={pagination._limit} /> : <ProductLacoste products={Product} />}
          <Pagination
