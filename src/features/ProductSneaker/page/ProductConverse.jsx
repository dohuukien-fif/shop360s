...
import ProductHatAdidas from './../component/product/productList/ProducConverse/index';
import './stylesQuanJeans.scss';
import ProductFilter from './../component/product/ProductFilter/FilteConverse/index';
  ...
  return (
    <div className="product_trouser">
      <div className="product_trouser_title-trouser">
        <span>
          {' '}
          <Link to="/">Trang chủ</Link> / <Link to="/Giay">Giày</Link> / Giày Converse
        </span>
      </div>
      <h2>GIÀY ADIDAS</h2>
