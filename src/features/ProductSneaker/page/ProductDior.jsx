...
import ProductDolce from './../component/product/productList/ProducDior/index';
import './stylesQuanJeans.scss';
import ProductFilter from './../component/product/ProductFilter/FilteDior/index';
  ...
  return (
    <div className="product_trouser">
      <div className="product_trouser_title-trouser">
        <span>
          {' '}
          <Link to="/">Trang chủ</Link> / <Link to="/Giay">Giày</Link> / Giày Dior
        </span>
      </div>
