...
import ProductQuanJean from './../component/product/productList/ProductQuanAu/index';
import './stylesQuanJeans.scss';
import ProductFilter from './../component/product/ProductFilter/FilterQuanAu/index';
  ...
  return (
    <div className="product_trouser">
      <div className="product_trouser_title-trouser">
        <span>
          {' '}
          <Link to="/">Trang chủ</Link> / <Link to="/Quan">Quần</Link> / Quần Âu
        </span>
      </div>
