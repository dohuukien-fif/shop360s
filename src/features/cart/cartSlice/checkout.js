...
const InforlSlice = createSlice({
  name: 'totalCart',
  initialState: {
    checkout: JSON.parse(localStorage.getItem('passss')) || [],
    removecheckout: JSON.parse(localStorage.getItem('remocheckssss')) || [],
  },
...
export const { removeCheckout, addRemoCheckout, addCheckout, canleCheckout } = actions;
