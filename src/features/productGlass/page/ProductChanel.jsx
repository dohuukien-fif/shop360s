...
import ProductChanel from './../component/product/productList/ProductChanel/index';
import './stylesQuanJeans.scss';
import ProductFilter from './../component/product/ProductFilter/FilterChanel/index';
  ...
  return (
    <div className="product_trouser">
      <div className="product_trouser_title-trouser">
        <span>
          {' '}
          <Link to="/">Trang chủ</Link> / <Link to="/Kinh">Kính</Link> / Kính Chanel
        </span>
      </div>
      <h2>Kính Chanel</h2>
      <div className="content_trouser">
        ...
        <div className="content_trouser_right-trouser">
          ...
          {Loading ? <Seleken length={12} /> : <ProductChanel products={Product} />}
          <Pagination
